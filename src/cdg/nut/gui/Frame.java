...
public abstract class Frame {
	...
	public void draw()
	{
		...
		if(((this.oldMouseX != Mouse.getX() || this.oldMouseY != Mouse.getY()) && this.selectSkip > this.maxSelectSkip && Mouse.isInsideWindow()))
		{
			this.selectSkip = 0;
	...
	private void select()
	{
		...
		int[] vs = new int[]{(int) (pixel.get(0) & 0xFF),(int) (pixel.get(1) & 0xFF),(int) (pixel.get(2) & 0xFF),(int) (pixel.get(3) & 0xFF)};
